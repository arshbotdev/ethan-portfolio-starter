    ...
    <div className="bg-[#d5d7d9] h-full ">
      ...
      <div className=" justify-center align-middle xl:flex py-10">
        ...
        <div className="w-[1200px] h-[800px]  absolute -right-[150px] -bottom-[200px]">
          ...
          <motion.div variants={fadeIn('up',0.5)} initial="hidden" animate="show" exit="hidden" transition={{duration: 1, ease:'easeInOut'}} className="w-full h-full max-w-[737px] absolute -bottom-52 lg:bottom-20 lg:right-[8%]">
            <Avatar/>
          </motion.div>
        </div>
