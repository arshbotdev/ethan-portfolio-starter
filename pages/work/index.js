...
const Work = () => {
  ...
  return (
    <div className=' h-full bg-white/90 py-16 md:py-24 lg:py-32 xl:py-36 flex items-center relative'>
      <Head>
    ...
    <div className=' xl:px-[170px]  '>
      <Circles />
      <div className='container  px-4 md:px-8 sm:px-0 lg:px-12 xl:px-16 justify-center'>
        <div className='flex flex-col xl:flex-row gap-x-8 justify-center'>
          <div className=' text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0 py-10 sm:px-0 md:mb-0 md:py-10 w-[300px] justify-center' >
            <motion.h2 variants={fadeIn('up', 0.3)} initial='hidden' animate='show' exit='hidden' className='h2 xl:mt-8 text-black'>
              My Projects <span className=' text-accent'>.</span>
            </motion.h2>
            <motion.p variants={fadeIn('down',0.3)} initial="hidden" animate="show" exit="hidden" className="max-w-md md:max-w-xl mx-auto md:mx-0 mb-6 md:ml-16 text-left text-black/90">
